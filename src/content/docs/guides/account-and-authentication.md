...
2. メールアドレスを入力
![メール入力](../../../../public/account/account-signin.png)
3. 「コードを送信」ボタンをクリック
4. 入力したメールアドレスに認証コードが送信される
5. メール内のコードをを入力し、ログインをクリック
![認証コードを入力](../../../../public/account/account-signin-enter-authentication-code.png)
